...
/**
 * <p>
 * A class to collect information on an encryption parameter set.
 * An instance of this class holds the data for a single parameter set
 * in its public members.
 * <p>
 * The static function getKeyParams() can be used to retrieve the
...
public class KeyParams
{
     ...
     * Constructor.
     */
    private KeyParams(OID _oidEnum,
                      int _N,
                      int _p,
                      int _q,
                      int _df,
